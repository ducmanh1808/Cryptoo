...
const CryptoDetails = () => {
    ...
    const [genericStats, setGenericStats] = useState([]); 
    useEffect(() => {
        setStats([
            {
                title: 'Price to USD',
    ...
    const time = useMemo(() => {
        return ['3h', '24h', '7d', '30d', '3m', '1y', '3y', '5y'];
    }, []);
    ...
    return (
        <Col className="coin-detail-container">
            <Col className="coin-heading-container">
                ...
                <p>
                    {cryptoDetails?.name} price in US Dollar. View value
            ...
            <Col className="stats-container">
                <Col className="coin-value-statistics">
                    <Col className="coin-value-heading">
                        ...
                        <p>
                            An over view statistic of {cryptoDetails?.name},
                            such as base and quote currency, rank and trading
                            volume.
                        </p>
                    </Col>
                ...
                <Col className="other-stats-info">
                    <Col className="coin-value-heading">
                        ...
                        <p>
                            An overview showing the statistics of all crypto
                            currencies.
                        </p>
                    </Col>
